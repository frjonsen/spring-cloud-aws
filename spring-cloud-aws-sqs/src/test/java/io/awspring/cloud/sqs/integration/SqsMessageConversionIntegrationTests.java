...
class SqsMessageConversionIntegrationTests extends BaseSqsIntegrationTest {
	...
	static class ResolvesPojoWithEventBridgeAnnotationListener {
		...
		@SqsListener(queueNames = RESOLVES_POJO_FROM_EVENTBRIDGE_MESSAGE_QUEUE_NAME, id = "resolves-pojo-with-eventbridge-message", factory = "defaultSqsListenerContainerFactory")
		...
		@SqsListener(queueNames = RESOLVES_POJO_FROM_EVENTBRIDGE_MESSAGE_LIST_QUEUE_NAME, id = "resolves-pojo-with-eventbridge-message-list", factory = "defaultSqsListenerContainerFactory")
